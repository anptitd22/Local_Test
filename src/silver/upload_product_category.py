...
#variable
file_path = '../../dataset/datamart/ProductCategory.csv'
...
def upload_to_iceberg(df: DataFrame) -> None:
    ...
    try:
        ...
        tbl = catalog.create_table("silver.product_category", schema=schema, partition_spec=partition_silver)
    except:
        tbl = catalog.load_table("silver.product_category")
...
def delete_iceberg_table() -> None:
    ...
    try:
        catalog.drop_table("silver.product_category")
        print("Table 'silver.product_category' has been deleted.")
